...
// Location data for different counties in Kenya
const LOCATION_DATA = {
...
// Enhanced CCTV Monitoring Component
    ...
    <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100 hover:shadow-3xl transition-all duration-500">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            <div className={`absolute -top-1 -right-1 w-4 h-4 ${isMonitoring ? 'bg-green-400 animate-pulse' : 'bg-gray-400'} rounded-full border-2 border-white`}></div>
          </div>
          <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <button
          ...
          className={`flex items-center justify-center space-x-3 py-4 px-6 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105 ${
            isMonitoring 
      ...
      <div className="mb-6">
        <div className="bg-gradient-to-br from-gray-900 via-gray-800 to-black rounded-2xl aspect-video flex items-center justify-center relative overflow-hidden shadow-inner">
          ...
          <div className="absolute inset-0 opacity-10">
            ...
            <div className="absolute bottom-6 left-1/3 w-1 h-1 bg-yellow-400 rounded-full animate-bounce"></div>
          </div>
          <div className="relative z-10 text-center">
            <Video className="w-20 h-20 text-gray-400 mx-auto mb-3" />
            <p className="text-gray-300 font-semibold text-lg">{selectedCamera}</p>
            <p className="text-gray-400 text-sm">Live Feed - {userLocation}</p>
            <div className="mt-2 flex items-center justify-center text-xs text-gray-500">
              <MapPin className="w-3 h-3 mr-1" />
              <span>{locationInfo.lat.toFixed(4)}, {locationInfo.lng.toFixed(4)}</span>
            </div>
          </div>
          {isMonitoring && (
            <div className="absolute top-6 right-6 flex items-center space-x-2 bg-red-500 text-white px-4 py-2 rounded-full text-sm font-medium shadow-lg">
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            ...
            <div className="text-center p-4 bg-white rounded-xl shadow-sm">
              ...
              <p className={`font-bold text-lg ${
                lastAnalysis.urgency === "Critical" ? "text-red-600" :
              ...
              <div key={report.id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-gray-100 transition-colors">
                <div className="flex items-center space-x-3">
                  <div className={`w-3 h-3 rounded-full ${
                    report.analysis.urgency === "Critical" ? "bg-red-500" :
                ...
                <div className="text-right">
                  <p className={`text-sm font-semibold ${
                    report.analysis.urgency === "Critical" ? "text-red-600" :
...
// Enhanced Live Camera Component
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center space-x-3">
          <div className="relative">
            ...
            <div className={`absolute -top-1 -right-1 w-4 h-4 ${isStreaming ? 'bg-green-400 animate-pulse' : 'bg-gray-400'} rounded-full border-2 border-white`}></div>
          </div>
          <div>
          ...
          <div className="mt-6 flex items-center space-x-2 p-4 bg-white rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-green-600">
                {analysis.location} County - {analysis.coordinates.lat.toFixed(4)}, {analysis.coordinates.lng.toFixed(4)}
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="text-center p-5 bg-white rounded-xl shadow-sm border border-gray-100">
              <div className={`w-12 h-12 rounded-xl flex items-center justify-center mx-auto mb-3 ${
                analysis.urgency === "Critical" ? "bg-gradient-to-br from-red-100 to-red-200" :
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        report.analysis.urgency === "Critical"
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl p-10 max-w-lg w-full text-center shadow-2xl">
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          ...
          You'll receive updates on the collection status and environmental impact.
        </p>
        <button
          onClick={onClose}
